#ifndef __tp_comm_service_testclient_hpp__
#define __tp_comm_service_testclient_hpp__
...
namespace testapp {
    ...
    public:
        testapp()
            : service_(
                    0, service::Multicast, "239.0.32.4", 44332, false, "127.0.0.1")
            , manager_(service_, *this)
        {
            manager_.interested_service_id(999);
        }
...
#endif//__tp_comm_service_testclient_hpp__
